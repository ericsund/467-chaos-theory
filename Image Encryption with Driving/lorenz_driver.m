function [x,y,z] = lorenz_driver(n,level,s,r,b,x0,y0,z0,h,drive)
%Syntax: [x,y,z]=lorenz_solver(n,level,s,r,b,x0,y0,z0,h)
%_________________________________________________
% This version has been modified to include a driving signal
%
...
for i = 2:n
    ...
    ydot(2) = r*drive(i-1) - y(i-1,2) - drive(i-1)*y(i-1,3);
    ydot(3) = drive(i-1)*y(i-1,2) - b*y(i-1,3);
    y(i, :) = y(i-1,:) + h*ydot;
end
